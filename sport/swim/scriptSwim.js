function generateProgram(){
    ...
    const url=`http://localhost:3000/api/sport/swim/${level}`;
    fetch(url, {
        method: 'GET',
        headers: {
    ...
    .then(data => {
        //Appelle la fonction swimProgram avec en paramètre data pour pouvoir exploiter le json    
        swimProgram(data)
    })    
    .catch(error => {    
        console.error(error);
